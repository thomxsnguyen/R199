...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Interpolate thermal data CSV files to 100 rows with uniform time steps.")
    parser.add_argument("--input", "-i", default=".",
                        help="Input directory containing CSV files (default: current directory)")
    parser.add_argument("--output", "-o", default="interpolated_csvs",
                        help="Output directory for interpolated CSV files (default: interpolated_csvs)")
