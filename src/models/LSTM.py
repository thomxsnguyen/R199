...
def train_model():
    ...
    train_paths = glob.glob(os.path.join(script_dir, "data", "old", "train", "*.csv"))
    val_paths = glob.glob(os.path.join(script_dir, "data", "old", "validation", "*.csv"))
    test_paths = glob.glob(os.path.join(script_dir, "data", "old", "testing", "*.csv"))
